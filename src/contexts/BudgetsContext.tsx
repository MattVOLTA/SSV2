...
interface BudgetsContextType {
  ...
  loading: boolean;
  error: string | null;
  addBudget: (name: string, amount: number) => Promise<Budget>;
  updateBudget: (budgetId: string, updates: { name?: string; amount?: number }) => Promise<Budget>;
  deleteBudget: (budgetId: string) => Promise<void>;
  updateExpense: (expenseId: string, updates: { description?: string; amount?: number; expense_date?: string }) => Promise<Expense>;
